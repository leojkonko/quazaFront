            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input v-model="formData.nomeCompleto" type="text" required
                            placeholder="Digite seu nome completo" :class="['text-gray-700 mt-1 block w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder-gray-400',
                    ...
                    <div>
                        ...
                        <input v-model="formData.cpf" v-mask="'###.###.###-##'" type="text" required
                            placeholder="000.000.000-00" :class="['text-gray-700 mt-1 block w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder-gray-400',
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <input v-model="formData.dataNascimento" type="date" required :class="['mt-1 block w-full pl-4 pr-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all appearance-none text-gray-700 bg-white',
                    ...
                    <div>
                        ...
                        <input v-model="formData.email" type="email" required placeholder="Digite seu email" :class="['text-gray-700 mt-1 block w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder-gray-400',
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input v-model="formData.senha" type="password" required minlength="6"
                            placeholder="Digite sua senha" :class="['text-gray-700 mt-1 block w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder-gray-400',
                    ...
                    <div>
                        ...
                        <input v-model="formData.confirmacaoSenha" type="password" required minlength="6"
                            placeholder="Confirme sua senha" :class="['text-gray-700 mt-1 block w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder-gray-400',
